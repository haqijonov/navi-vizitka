  ...
  const unsortedPayload = [
    {
      ...
      metadata: {
        ...
        utm_source: sanitizedUtm.utm_source,
        utm_medium: sanitizedUtm.utm_medium,
        utm_campaign: sanitizedUtm.utm_campaign,
        utm_term: sanitizedUtm.utm_term,
        utm_content: sanitizedUtm.utm_content,
      },
      _embedded: {
        leads: [
          {
